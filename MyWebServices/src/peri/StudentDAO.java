...
public class StudentDAO {
	...
	{
		Connection con = PeriDAO.DBConnection();
		PreparedStatement ps = con.prepareStatement("update student set studentName=?, age=?,marks=? where studentId =? ");
	...
	public List<Student> selectAll() throws Exception
	{
		...
		System.out.println("reached select All in DAO where studentId=");
	...
	/*public List<Student> selectAllform(String username) throws ClassNotFoundException, SQLException {
		// TODO Auto-generated method stub
		Connection con = PeriDAO.DBConnection();
		Statement statement = con.createStatement();
		String sql="select * from student where studentName="+username;
		ResultSet rs = statement.executeQuery(sql);
		List<Student> studentList = new ArrayList<Student>();
